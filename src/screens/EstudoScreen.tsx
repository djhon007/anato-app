...
export default function EstudoScreen() {
  ...
  const videoContent: Record<string, any[]> = {
    ...
    '2ª temporada - Membros Superiores': [
      { id: 10, title: 'Osteologia da Clavícula', dur: '--:--', url: 'https://youtu.be/OncazDKP6Lw?si=7J50Wq1VEQJpM9WQ' },
      { id: 11, title: 'Osteologia da Escápula', dur: '--:--', url: 'https://youtu.be/Je91jEQyeco?si=JNIhj-XgJcJfnaHa' },
      { id: 12, title: 'Osteologia do Úmero', dur: '--:--', url: 'https://youtu.be/H1J3mPsgS5E?si=rM59_7dexQECmrYd' },
      { id: 13, title: 'Osteologia do Rádio', dur: '--:--', url: 'https://youtu.be/upqADN1kdhI?si=CFKEKwBhNBg0C95i' },
      { id: 14, title: 'Osteologia da Ulna', dur: '--:--', url: 'https://youtu.be/cyOu2B7cwbk?si=onGUeOYt8Nk4OpSg' },
      { id: 15, title: 'Osteologia do Carpo, Metacarpo e Falanges', dur: '--:--', url: 'https://youtu.be/6TTO5zUSArM?si=n09-R0gnqdmT3MfW' },
      { id: 16, title: 'Articulação Esternoclavicular', dur: '--:--', url: 'https://youtu.be/lK8jdgiK4sE?si=DJg7xmQwQIrlSmSF' },
      { id: 17, title: 'Articulação Acromioclavicular', dur: '--:--', url: 'https://youtu.be/ODAQKlbwxBU?si=a78nvpZAwBJygVAb' },
      { id: 18, title: 'Articulação do Ombro', dur: '--:--', url: 'https://youtu.be/ykMi1NjvCYQ?si=br9y0gKVgrLhq7vZ' },
      { id: 19, title: 'Articulação do Cotovelo', dur: '--:--', url: 'https://youtu.be/nr5F9_oVUO8?si=xVBLdMKqOj-IjhmW' },
      { id: 20, title: 'Articulação Rádioulnar Proximal', dur: '--:--', url: 'https://youtu.be/ymcpmnfRzPU?si=4fr-zTZ1_h_FMUim' },
      { id: 21, title: 'Articulação Rádioulnar Média', dur: '--:--', url: 'https://youtu.be/bYj7so7NzPk?si=Z7xNya0wEDXWCiaf' },
      { id: 22, title: 'Articulação Rádioulnar Distal', dur: '--:--', url: 'https://youtu.be/OXf4Tbh71ks?si=GkHnpOKHrJUI9qSD' },
      { id: 23, title: 'Articulação do Punho (Radiocarpal)', dur: '--:--', url: 'https://youtu.be/vVdYXxAN7UM?si=fXNw0r1y2NR_78Wu' },
      { id: 24, title: 'Articulação Intercárpica - Mediocárpica', dur: '--:--', url: 'https://youtu.be/mJvqgWJ2B6o?si=PYLq-it9Hcp79O5h' },
      { id: 25, title: 'Articulação Carpometacarpal', dur: '--:--', url: 'https://youtu.be/Trz_0Ho_1vU?si=i1lDWTGT509VIHCJ' },
      { id: 26, title: 'Articulação Trapeziometacarpal', dur: '--:--', url: 'https://youtu.be/cBjafl1_VAc?si=dp1JE-CafKEaQ70-' },
      { id: 27, title: 'Articulação Metacarpofalangeana', dur: '--:--', url: 'https://youtu.be/mUg4lwIwoac?si=tqybX8ecZ8qRS-XZ' },
      { id: 28, title: 'Articulação Interfalangeana', dur: '--:--', url: 'https://youtu.be/BE8mt4q_Tcw?si=gIbYlVV0LAvniy3p' },
      { id: 29, title: 'Músculos Toracoapendiculares / Região Peitoral', dur: '--:--', url: 'https://youtu.be/YbAxja72K7Y?si=VWPq0MeazSunY2GC' },
      { id: 30, title: 'Músculos que Conectam os MMSS à Coluna', dur: '--:--', url: 'https://youtu.be/-lu4RyP7s20?si=aq-3nnhAvrLVER6r' },
      { id: 31, title: 'Músculos do Ombro', dur: '--:--', url: 'https://youtu.be/RDedAvxLqo4?si=DU3pNy53LabFguVJ' },
      { id: 32, title: 'Músculos do Braço', dur: '--:--', url: 'https://youtu.be/Vx6VUasPDLM?si=OFJ082dJOjjNXglG' },
      { id: 33, title: 'Músculos do Antebraço - Anterior Superficial', dur: '--:--', url: 'https://youtu.be/444MRPvWs7g?si=sen3SWMT_frDb7UV' },
      { id: 34, title: 'Músculos do Antebraço - Anterior Profunda', dur: '--:--', url: 'https://youtu.be/zlFLFjrXo6E?si=9s89Fc1VAX363F4F' },
      { id: 35, title: 'Músculos do Antebraço - Posterior Superficial', dur: '--:--', url: 'https://youtu.be/owzlOHnNGZk?si=cIxZbwksYNPvwfOd' },
      { id: 36, title: 'Músculos do Antebraço - Posterior Profunda', dur: '--:--', url: 'https://youtu.be/0ZIqPyuRNyY?si=98TYWgR0Q6EQCp9L' },
      { id: 37, title: 'Músculos da Mão', dur: '--:--', url: 'https://youtu.be/dS6eBX8CKpQ?si=enp4SujoYYi0eslp' },
      { id: 38, title: 'Plexo Braquial', dur: '--:--', url: 'https://youtu.be/WYOJnOJzAfg?si=HpLoEqYlfXct9Wba' },
      { id: 39, title: 'Nervos Motores do Plexo Braquial', dur: '--:--', url: 'https://youtu.be/v5GlNwPUADQ?si=Zkr7LyofPzNYIIyB' },
      { id: 40, title: 'Irrigação Arterial dos MMSS', dur: '--:--', url: 'https://youtu.be/rp2Ilg53FQE?si=tQcBLwLK_IZDC3xX' },
      { id: 41, title: 'Drenagem Venosa dos MMSS', dur: '--:--', url: 'https://youtu.be/Lzi7nwdxkEo?si=fD658ZcxJfupGbab' },
    ],
